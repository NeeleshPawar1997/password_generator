...
class PasswordGenerator:
    def __init__(self, root):
        ...
        self.heading_label = tk.Label(root, text="Password Generator", font=("Arial", 18, "bold" , "underline"),bg="light green", fg="dark blue")
        ...
        self.generated_password_label = tk.Label(root, text="Generate Password:", font=("Arial", 10),bg ="light pink")
